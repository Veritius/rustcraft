...
## License
- All source code is licensed under the [MIT license](https://mit-license.org/). A copy is available in `LICENSE-MIT`.
- All assets and art is licensed under the [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license. A copy is available in `LICENSE-CC` unless otherwise listed.
